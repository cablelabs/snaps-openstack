...
| image | N | images can be build or pulled from docker hub for deployment by setting build or pull (default is pull). |
| repo | Y | container images to pulled from the specific docker hub namespace or kolla namespace (default).|
