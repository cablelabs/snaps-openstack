...
SINGLE_NODE_KOLLA_YAML = "single_node_kolla_newton.yaml"
MULTI_NODE_KOLLA_COMPUTE_YAML = "multinode_kolla_compute_newton.yaml"
MULTI_NODE_KOLLA_ISO_NWK_YAML = "multinode_kolla_iso_network.yaml"
MULTI_NODE_KOLLA_CONTROLLER_YAML = "multinode_kolla_controller_newton.yaml"
MULTI_NODE_KOLLA_COMPUTE_YAML_PIKE = "multinode_kolla_compute_pike.yaml"
MULTI_NODE_KOLLA_CONTROLLER_YAML_PIKE = "multinode_kolla_controller_pike.yaml"
SINGLE_NODE_KOLLA_YAML_PIKE = "single_node_kolla_pike.yaml"
